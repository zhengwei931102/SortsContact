...
- (UITableView *)friendTableView {
    if (!_friendTableView) {
        _friendTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 132, kScreenWidth, kScreenHeight-132-34) style:UITableViewStylePlain];
...
- (UISearchBar *)searchBar {
    if (!_searchBar) {
        _searchBar = [[UISearchBar alloc]initWithFrame:CGRectMake(0, 88, kScreenWidth, 44)];
...
//        self.navigationController.navigationBarHidden = YES;
        _searchBar.frame = CGRectMake(0, 88, kScreenWidth, 44);
